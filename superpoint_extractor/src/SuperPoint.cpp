...
// nx1 vector normalization 1xn dot nx1 
...
// bool SuperPoint::processOutput(const BufferManager &buffers, Eigen::Matrix<double, 259, Eigen::Dynamic> &features) {
//     keypoints_.clear();
//     descriptors_.clear();
...
//     findHighScoreIndex(scores_vec, keypoints_, semi_feature_map_h, semi_feature_map_w,
//                           super_point_config_.keypoint_threshold);
//     removeBorders(keypoints_, scores_vec, super_point_config_.remove_borders, semi_feature_map_h, semi_feature_map_w);
//     topKeypoints(keypoints_, scores_vec, super_point_config_.max_keypoints);
...
//     sampleDescriptors(keypoints_, output_desc, descriptors_, desc_feature_dim, desc_feature_map_h, desc_feature_map_w);
